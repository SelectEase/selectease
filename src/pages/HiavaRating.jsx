...
const ratingsData = [
  ...
  { label: 'Ease of Use', score: 4.1 },
  { label: 'Features', score: 4.2 },
  { label: 'Customer Support', score: 4.0 },
  { label: 'Trial User Conversion Rate', score: 4.0 },
];

const scoreCards = [
  { label: 'Feature Score', percent: 80.25, color: '#28a745' },
  { label: 'Social Impact Score', percent: 73.25 },
  { label: 'Brand Score', percent: 77.25 },
  { label: 'Innovation Score', percent: 70 },
