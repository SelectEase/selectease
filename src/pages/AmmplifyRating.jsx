...
const scoreCards = [
  { label: 'Feature Score', percent: 74.5 },
  { label: 'Social Impact Score', percent: 72.5 },
  { label: 'Brand Score', percent: 78.5 },
  { label: 'Innovation Score', percent: 76.5 },
  { label: 'NPS', percent: 85 },
  { label: 'Highly Recommended', percent: 85, color: '#28a745' },
];

const AmmplifyRating = () => {
  return (
    <Container>
