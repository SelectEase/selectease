...
const scoreCards = [
  { label: 'Feature Score', percent: 83.33, color: '#28a745' },
  { label: 'Social Impact Score', percent: 64.3 },
  { label: 'Brand Score', percent: 86.67 },
  { label: 'Innovation Score', percent: 71.67 },
