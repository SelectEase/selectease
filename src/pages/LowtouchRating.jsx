...
const ratingsData = [
  ...
  { label: 'Trial User Conversion Rate', score: 4.2 },
];

const scoreCards = [
  { label: 'Feature Score', percent: 70.5 },
  { label: 'Social Impact Score', percent: 58.25 },
  { label: 'Brand Score', percent: 75.5 },
  { label: 'Innovation Score', percent: 65.75 },
  { label: 'NPS', percent: 85 },
  { label: 'Highly Recommended', percent: 85, color: '#28a745' },
];

const LowtouchRating = () => {
  return (
    <Container>
