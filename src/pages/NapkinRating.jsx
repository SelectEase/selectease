...
const scoreCards = [
  { label: 'Feature Score', percent: 84, color: '#28a745' },
  { label: 'Social Impact Score', percent: 62.83 },
  { label: 'Brand Score', percent: 78.33 },
  { label: 'Innovation Score', percent: 68.33 },
